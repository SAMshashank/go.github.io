! function(e) {
    ...
    e.fn.fusion_scroll_to_anchor_target = function(t) {
        ...
        if (t = void 0 !== t ? t : 0, f.length && "" !== u) {
            ...
            return o = fusion.getAdminbarHeight(), i = e(document).scrollTop(), d ? (e("body").addClass("fusion-scrolling-active"), (p = fusionGetStickyOffset()) || (p = o), s = f.offset().top - p - t) : (n = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, s = f.offset().top - o - n - t), a = Math.abs(i - s) / 2, r = i > s ? i - a : i + a, e(h).animate({
                scrollTop: r
            }, {
                duration: 400,
                easing: "easeInExpo",
                complete: function() {
                    o = fusion.getAdminbarHeight(), d ? ((p = fusionGetStickyOffset()) || (p = o), s = f.offset().top - p - t) : (n = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, s = f.offset().top - o - n - t), e(h).animate({
                        scrollTop: s
                    }, 450, "easeOutExpo", function() {
                        location.hash && "#_" === location.hash.substring(0, 2) && "history" in window && "replaceState" in history && history.replaceState("", window.location.href.replace("#_", "#"), window.location.href.replace("#_", "#")), d && (g = fusionGetStickyOffset(), p !== g && (s = f.offset().top - g - t, e(h).animate({
                            scrollTop: s
